    ...
    <footer className="bg-primary text-white">
      <div className="container-narrow">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <div>
                ...
                <p className="text-accent text-sm">Official Government Initiative</p>
              </div>
            </div>
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <span className="text-sm text-white/70 leading-none block">Young India Skills University</span>
                  </div>
                </div>
              ...
              >
                ...
                <ul className="space-y-3">
                  {combinedLinks.map((link) => (
                    <li key={link}>
                      <a href="#" className="text-base text-white/80 hover:text-accent transition-colors inline-flex items-center gap-2">
              ...
              >
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-base text-white/80 leading-relaxed">{contactInfo.address}</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <Phone className="w-5 h-5 flex-shrink-0 text-accent" />
                    <span className="text-base text-white/80">{contactInfo.admissionsPhone}</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <Mail className="w-5 h-5 flex-shrink-0 text-accent" />
                    <span className="text-base text-white/80">{contactInfo.admissionsEmail}</span>
                  </li>
                </ul>
              </motion.div>
            </div>
        ...
        >
          ...
          >
            <p className="text-sm text-white/50 flex items-center justify-center md:justify-start gap-2">
