...
function LeaderCard({ leader, index }: LeaderCardProps) {
  return (
    <motion.div
      ...
      className="bg-white/5 backdrop-blur border border-white/10 rounded-lg p-8 hover:bg-white/10 transition-colors"
    >
      <div className="flex items-start gap-6">
        <div className="flex-shrink-0">
          <div className="w-20 h-20 rounded-full bg-gold/20 flex items-center justify-center border-2 border-gold">
